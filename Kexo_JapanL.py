...
2. Small Kana""")
    ...
    print("Kexo: Alright! looks like we're jumping straight to the material. There's currently two modes, i'll let you decide!")
    print("""
1. Define a hiragana to romaji
2. Define a hiragana into it's actual meaning in english""")
    Japan_Mode = input("> ").strip()

    print()

    if Japan_Mode == "1":
      print(f"A word in japanese hiragana will be shown and you will be asked to translate it to romaji. The words itself is associated with clean air, i'll tell you the definition of it after you answer! There will be 10 words, are you ready {name}? (press enter to continue)")
      input()
      
      Word_Gen("romaji", name)

    elif Japan_Mode == "2":
      print(f"A word in japanese hiragana will be shown and you will be asked to translate it in english. The words itself is associated with clean air. There will be 10 words, are you ready {name}? (press enter to continue)")
